...
using SparkAll.Editor;
using SparkAll.Viewer;
...
namespace SparkAll
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            tslAbout.Text = "SparkAll " + ver.Major + "." + ver.Minor + "." + ver.Build + " (Beta)" + "\n" +
                            "(C)2008-2010, Aru";
            ...
            using (new WaitCursor(this))
            {
                ...
                while (gamePath == null)
                {
                    ...
                    if (fbd.ShowDialog() == DialogResult.Cancel)
                    {
                        MessageBox.Show(
                            ...
                            "SparkAll can not run without this file.", "Error", MessageBoxButtons.OK,
                ...
                if (key == null)
                {
                    string message = "Your " + keyUtil.ExecutableName + " seems to be modified or is a newer version than this tool supports. " +
                                    "SparkAll can not run without a supported " + keyUtil.ExecutableName + " file." + "\n" + "Would you like to check for updates?";
